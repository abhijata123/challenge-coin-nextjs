/*
  # Fix social notification function
  
  1. Changes
    - Update create_social_notification function to handle null post content
    - Fix post like notifications
    
  2. Security
    - Maintain existing security model
*/

-- Update social notification function to handle null content
