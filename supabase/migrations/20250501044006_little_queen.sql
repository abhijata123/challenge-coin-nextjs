-- Update transfer_coins function to use correct Supabase URL
...
BEGIN
  ...
  -- Extract filename from Coin Image URL
  v_coin_filename := substring(v_coin."Coin Image" from '/Coin%20Images/(.*)$');
  ...
  -- Send data to webhook with proper Supabase URL
  PERFORM net.http_post(
    ...
    body := jsonb_build_object(
      ...
      'coinDetails', jsonb_build_object(
        ...
        'quantity', p_quantity,
        'supabaseUrl', 'https://credhwdecybwcrkmhtrn.supabase.co/storage/v1/object/public/Coin%20Images/' || v_coin_filename
      )
    )
  );
