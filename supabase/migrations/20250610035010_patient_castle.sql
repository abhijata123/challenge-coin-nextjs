/*
  ...
  1. Changes
    - Check if receiver exists in User Dps table
    - If receiver exists, proceed with normal transfer
    - If receiver doesn't exist, create pending transfer
    - Return appropriate status ('success' or 'pending')
*/
