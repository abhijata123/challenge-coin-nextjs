/*
  # Fix coin transfer function to handle newly uploaded coins
  
  1. Changes
    - Update transfer_coins function to properly find coins by ID
    - Fix the query to check both UserId and Username
...
-- Update transfer_coins function to fix coin lookup
