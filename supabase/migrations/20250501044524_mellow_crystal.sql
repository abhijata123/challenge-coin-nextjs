-- Update transfer_coins function to correctly handle Supabase storage URL
...
BEGIN
  ...
  -- Send data to webhook with direct Supabase storage URL
  PERFORM net.http_post(
    ...
    body := jsonb_build_object(
      ...
      'coinDetails', jsonb_build_object(
        ...
        'coinImage', 'https://credhwdecybwcrkmhtrn.supabase.co/storage/v1/object/public/Coin%20Images//2025-04-29T21-38-55-680Z-jp534ptzzb.png',
        'quantity', p_quantity
      )
    )
  );
