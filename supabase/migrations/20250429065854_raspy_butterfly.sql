/*
  ...
  1. Changes
    - Drop and recreate notifications table with correct references
    - Update notification functions to handle references properly
    - Ensure proper cascade behavior
*/

-- Drop existing notifications table and recreate with correct structure
