/*
  # Add public coin notification functionality
  
  1. Changes
    - Add function to notify followers when a coin is made public
    - Add trigger for public coin notifications
    - Update notifications type constraint to include public_coin
    
  2. Security
    - Maintain existing security model
*/

-- Update notifications table to allow public_coin type
DO $$ 
BEGIN
  IF EXISTS (
...
BEGIN
  ...
  IF OLD."Public Display" = false AND NEW."Public Display" = true THEN
    ...
    -- Log for debugging
    RAISE NOTICE 'Creating public coin notifications for coin % by user %', NEW."Coin Name", v_username;
