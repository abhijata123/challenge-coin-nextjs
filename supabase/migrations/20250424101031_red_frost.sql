/*
  # Remove rarity level functionality safely
  
  1. Changes
    - Remove rarity level from tables and functions
    - Update transfer functionality
    - Handle pending transfers
*/

-- Drop rarity level constraint safely
DO $$ 
BEGIN
  IF EXISTS (
    SELECT 1 
...
-- Drop rarity level column safely
DO $$ 
BEGIN
  IF EXISTS (
    SELECT 1 
...
-- Drop rarity_level from pending_coin_transfers safely
DO $$ 
BEGIN
  IF EXISTS (
    SELECT 1 
