/*
  ...
  1. Changes
    - Simplify the relationship between coin_questions and User Dps
    - Fix the query structure in the application
    - Make policies more permissive while maintaining security
