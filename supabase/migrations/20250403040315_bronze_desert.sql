/*
  # Fix coin transfer mode of acquiring
  
  1. Changes
    - Update transfer_coins function to set correct Mode Of Acquiring
    - Ensure compliance with mode_of_acquiring_check constraint
...
BEGIN
  ...
  ELSE
    ...
    VALUES (
      ...
      v_coin."BacksideUrl",
      CURRENT_DATE,
      'gifted',  -- Set Mode Of Acquiring to 'gifted' for transferred coins
      p_quantity,
