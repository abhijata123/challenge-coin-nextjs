/*
  # Update coin transfer to set Awarded By field
  
  1. Changes
    - Update transfer_coins function to set Awarded By field
    - Ensure sender's name appears in receiver's coin details
...
-- Update process_pending_transfers function to set Awarded By field
