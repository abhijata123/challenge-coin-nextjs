/*
  # Fix coin questions relationships
  
  1. Changes
    - Fix the relationship between coin_questions and User Dps table
    - Update the join queries in the application
...
-- First, let's fix the foreign key references
